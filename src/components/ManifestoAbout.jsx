...
import { Sparkles, CheckCircle2, ShieldCheck, MapPin, ArrowRight } from 'lucide-react';

export const ManifestoAbout = () => {
  return (
    <section id="sobre" className="bg-canvas py-20 lg:py-28 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Manifesto Banner */}
        <div className="max-w-4xl mx-auto bg-white border border-matte-gold/40 rounded-3xl p-8 sm:p-14 shadow-editorial text-center relative overflow-hidden mb-20">
          
          {/* Subtle quotation decoration */}
          <div className="text-matte-gold/20 text-8xl font-serif font-black absolute top-2 left-6 select-none pointer-events-none">
            “
          </div>
          ...
          <div className="relative z-10 space-y-6">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-matte-gold/40 text-graphite text-xs font-semibold tracking-wider uppercase bg-matte-gold/15">
              ...
              <span>MANIFESTO DE BELEZA CONSCIENTE</span>
            </div>

            <blockquote className="text-xl sm:text-2xl lg:text-3xl font-semibold text-graphite tracking-tight leading-snug">
              "Você não precisa mudar quem você é para rejuvenescer. A verdadeira beleza está em olhar no espelho e voltar a enxergar a sua <span className="text-matte-gold underline decoration-matte-gold/40 underline-offset-8 font-bold">melhor versão</span>."
            </blockquote>

            <div className="pt-2 flex items-center justify-center gap-3">
              <div className="h-px w-12 bg-matte-gold/40" />
              <p className="text-xs uppercase tracking-widest font-bold text-graphite">
                Dra. Patrícia Andrade • CRBM 35884
              </p>
              <div className="h-px w-12 bg-matte-gold/40" />
            </div>
          </div>
